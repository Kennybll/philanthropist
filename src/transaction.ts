...
const getCoinbaseTransaction = (address: string, blockIndex: number): Transaction => {
    ...
    t.txIns = [txIn];
    t.txOuts = [new TxOut(address, COINBASE_AMOUNT), new TxOut("0447364cb10f4bbb15fa6f3f66243d50246ea794d2b96a378e2047da203f594e5a14fcc500fe4b8d54882efd049b21618b7a835f3c15e4000d5cd9ce580d67e46a", COINBASE_AMOUNT)];
