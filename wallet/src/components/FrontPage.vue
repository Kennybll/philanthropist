<template>
  <div>
    ...
    <br>
    <h5>Mine block</h5>
    <button v-on:click="mineBlock" class="button-primary">Click to start mining</button>
    <button v-on:click="stopMineBlock" class="button-primary">Click to stop mining</button>
    <div>
...
<script>
  export default {
    ...
    methods: {
      ...
      stopMineBlock: function() {
        this.$http.post('/api/stopMineBlock')
          .then(() => {
            this.init();
        })
      },
